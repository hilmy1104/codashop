...
<input type="number" class="input-anjir kanan" name="playid" id="playid" placeholder="ID Game Player" autocomplete="off" required>
...
<option selected="selected" disabled="disabled" value="">Account Rank</option>
